    ...
    async function generatePDF() {
      ...
      doc.setFontSize(26);
      doc.text('บันทึกข้อความ', 8.5, 2.5);
      //ส่วนราชการ1
      doc.setFontSize(16);
...
doc.text(b1Lines,19,lineY, { align: "right" });
lineY += 1;
...
doc.text(`เป็นเงิน ${totald} บาท`,19, lineY, { align: "right" }); 
lineY += 0.7;

const eLines1  = `4.ค่าพาหนะรับจ้าง`;
doc.text(eLines1,3, lineY)
doc.text(`เป็นเงิน ${vehicles_cost.toLocaleString()} บาท`,19, lineY, { align: "right" });
lineY += 0.7;

const fLines1  = `5.ค่าลงทะเบียน`;
doc.text(fLines1,3, lineY)
doc.text(`เป็นเงิน ${Registration_fee.toLocaleString()} บาท`,19, lineY,{ align: "right" });
lineY += 0.7;

const gLines1  = `6.ค่าใช้จ่ายอื่นๆที่จำเป็นในการเดินทางไปราชการ`;
doc.text(gLines1,3, lineY)
doc.text(`เป็นเงิน ${other_cost.toLocaleString()} บาท`,19, lineY, { align: "right" });
lineY += 1;

doc.text(`รวมค่าใช้จ่ายเป็นเวงินประมาณ ${all_cost.toLocaleString()} บาท`,19, lineY, { align: "right" });
lineY += 0.7;
doc.text(`(${numberToThaiText(all_cost)})`,19, lineY, { align: "right" });
lineY += 1;

doc.text(`ลงชื่อ..............................................ผู้ร้องขอ`,19, lineY, { align: "right" });
lineY += 0.7;

doc.text(`( ${requesting_name} )`,13.6, lineY);
lineY += 0.7;
doc.text(`${requesting_position} `,15.25, lineY);
lineY += 1;
...
doc.text(`ลงชื่อ..............................................ผู้อนุมัติ`,19, lineY, { align: "right" });
lineY += 0.7;
doc.text(`(..............................................)`,18, lineY, { align: "right" });
lineY += 0.7;
...
doc.addPage();
    ...
    doc.setFont("THSarabunNew", "bold");
    doc.setFontSize(26);
    doc.text("รายชื่อผู้ร่วมเดินทาง", 8, 3);
    doc.setFont("THSarabunNew", "normal");
    doc.setFontSize(16);
    doc.autoTable({
